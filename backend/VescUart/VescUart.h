  ...
  struct dataCurrentMCCONFTemp {
    ...
    dataCurrentMCCONFTemp data_mcconf;
       ...
       /** Variable to hold firmware version */
         ...
         */
        void setSerialPort(MyUart* port);

        /**
         * @brief      Set the serial port for debugging
         * @param      port  - Reference to Serial port (pointer) 
         */
        void setDebugPort(MyUart* port);
         ...
         * @return     True if successfull otherwise false
         */
        bool getMcconfTempValues(uint8_t canId);

        /**
         * @brief      Sends a McConf temporary setup to VESC
         *
         * @return     True if successfull otherwise false
         */
        bool getMcconfTempValues(void);
         ...
         * @return     True if successfull otherwise false
         */
        void setMcconfTempValues(uint8_t canId);
