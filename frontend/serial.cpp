...
void SerialProcessor::init(const char *portName) {
...
void SerialProcessor::readSerial(std::function<void(std::string)> execFunc) {
...
void SerialProcessor::writeSerial(const char *data) {
